...
EP2_Server.o: EP2_Server.c Aux_Handlers.h DB_Manag_Sys.h Protocol.h
	$(CC) $(CFLAGS) -c EP2_Server.c 

EP2_Client.o: EP2_Client.c Hash_Game.h Protocol.h
	$(CC) $(CFLAGS) -c EP2_Client.c 

Aux_Handlers.o: Aux_Handlers.c Aux_Handlers.h DB_Manag_Sys.h Protocol.h
