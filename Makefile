...
EP2_Server.o: EP2_Server.c S_Aux_Handlers.h DB_Manag_Sys.h Protocol.h
	$(CC) $(CFLAGS) -c EP2_Server.c 

EP2_Client.o: EP2_Client.c C_Aux_Handlers.h Hash_Game.h Protocol.h
	$(CC) $(CFLAGS) -c EP2_Client.c 

S_Aux_Handlers.o: S_Aux_Handlers.c S_Aux_Handlers.h DB_Manag_Sys.h Protocol.h
	$(CC) $(CFLAGS) -c S_Aux_Handlers.c 

C_Aux_Handlers.o: C_Aux_Handlers.c C_Aux_Handlers.h Protocol.h
